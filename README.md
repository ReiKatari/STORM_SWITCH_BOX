...
[![Version](https://img.shields.io/badge/version-4.8.1-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_SWITCH_BOX)
...
1. Скачайте и запустите релизный файл `STORM_SWITCH_BOX_4.8.1_Setup.exe`.
...
* `Files/` — инсталлятор `STORM_SWITCH_BOX_4.8.1_Setup.exe`, сертификат `STORM_Certificate.cer` и сервисные скрипты.
