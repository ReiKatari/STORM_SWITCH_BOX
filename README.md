...
[![Version](https://img.shields.io/badge/version-4.8.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_SWITCH_BOX)
...
**STORM SWITCH BOX** — компонент программного комплекса **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_SWITCH_BOX_4.8.0_Setup.exe.
2. Выберите режим:
