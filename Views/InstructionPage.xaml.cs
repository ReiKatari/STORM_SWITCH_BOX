        ...
        private List<TopicItem> GetTopicsRu()
        {
            return new List<TopicItem>
            {
                new TopicItem
                {
                    ...
                    {
                        container.Children.Add(new TextBlock { Text = "⚡ STORM SWITCH BOX v4.9.5", FontSize = 16, FontWeight = Microsoft.UI.Text.FontWeights.Bold });
                ...
                new TopicItem
                {
                    ...
                    Category = "Алгоритмы",
                    Icon = "\uE945",
                    DescriptionText = "Интеллектуальный алгоритм автоматического выбора метода сборки (Smart Processing), внедренный в v4.9.5:\n\n" +
                ...
                new TopicItem
                {
                    ...
                    Category = "Эмуляторы",
                    Icon = "\uE7FC",
                    DescriptionText = "STORM SWITCH BOX v4.9.5 предоставляет полную свободу в интеграции с локальными эмуляторами Nintendo Switch (STORM EDEN, Yuzu, Ryujinx, Suyu, Sudachi, Torzu, Citron и др.):\n\n" +
        ...
        private List<TopicItem> GetTopicsEn()
        {
            return new List<TopicItem>
            {
                ...
                new TopicItem
                {
                    ...
                    Category = "Algorithms",
                    Icon = "\uE945",
                    DescriptionText = "Intelligent automatic build method selection algorithm (Smart Processing) in v4.9.5:\n\n" +
