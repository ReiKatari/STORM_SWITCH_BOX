...
namespace StormSwitchBox.Views
{
    public sealed partial class InstructionPage : Page
    {
        ...
        private void InitializeTopics()
        {
            _allTopics = new List<TopicItem>
            {
                new TopicItem
                {
                    ...
                    {
                        container.Children.Add(new TextBlock { Text = "STORM SWITCH BOX v4.3.5", FontSize = 16, FontWeight = Microsoft.UI.Text.FontWeights.Bold });
        ...
        #region Interactive Task Simulator (v4.3.5)
        ...
        private void RunDispatchSimulation()
        {
            ...
            _simulatorResultsPanel.Children.Add(new TextBlock
            {
                Text = "результат симуляции v4.3.5 — Папка «Dispatch» (2 подпапки = 2 изолированные задачи):",
        ...
        private void RunCadenceSimulation()
        {
            ...
            _simulatorResultsPanel.Children.Add(new TextBlock
            {
                Text = "результат симуляции v4.3.5 — Папка «Cadence of Hyrule» (3 подпапки = 3 изолированные задачи):",
                FontWeight = Microsoft.UI.Text.FontWeights.SemiBold,
                FontSize = 14,
                Foreground = new SolidColorBrush(Microsoft.UI.Colors.LimeGreen)
            });
        ...
        private void SimulateCustomDroppedItems(IReadOnlyList<IStorageItem> items)
        {
            ...
            _simulatorResultsPanel.Children.Add(new TextBlock
            {
                Text = $"Результат симуляции анализа {items.Count} элементов по правилам v4.3.5:",
                FontWeight = Microsoft.UI.Text.FontWeights.SemiBold,
                FontSize = 14,
                Foreground = new SolidColorBrush(Microsoft.UI.Colors.LimeGreen)
            });
