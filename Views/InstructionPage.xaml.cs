        ...
        private void InitializeTopics()
        {
            _allTopics = new List<TopicItem>
            {
                new TopicItem
                {
                    ...
                    {
                        container.Children.Add(new TextBlock { Text = "⚡ STORM SWITCH BOX v4.8.1", FontSize = 16, FontWeight = Microsoft.UI.Text.FontWeights.Bold });
                ...
                new TopicItem
                {
                    ...
                    Category = "Алгоритмы",
                    Icon = "\uE945",
                    DescriptionText = "Интеллектуальный алгоритм автоматического выбора метода сборки (Smart Processing), внедренный в v4.8.1:\n\n" +
