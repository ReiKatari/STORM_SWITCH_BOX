...
namespace StormSwitchBox.Views
{
    public sealed partial class InstructionPage : Page
    {
        ...
        private List<TopicItem> GetTopicsRu()
        {
            return new List<TopicItem>
            {
                new TopicItem
                {
                    ...
                    {
                        container.Children.Add(new TextBlock { Text = "⚡ STORM SWITCH BOX v5.0.4", FontSize = 16, FontWeight = Microsoft.UI.Text.FontWeights.Bold });
                ...
                new TopicItem
                {
                    ...
                    Category = "Алгоритмы",
                    Icon = "\uE945",
                    DescriptionText = "Интеллектуальный алгоритм автоматического выбора метода сборки (Smart Processing), внедренный в v5.0.4:\n\n" +
                ...
                new TopicItem
                {
                    ...
                    Category = "Эмуляторы",
                    Icon = "\uE7FC",
                    DescriptionText = "STORM SWITCH BOX v5.0.4 предоставляет полную свободу в интеграции с локальными эмуляторами Nintendo Switch (STORM SWITCH, Yuzu, Ryujinx, Suyu, Sudachi, Torzu, Citron и др.):\n\n" +
                ...
                new TopicItem
                {
                    ...
                    DescriptionText = "Специализированный раздел «Homebrew» для автоматического распознавания, объединения и сборки любых портов и любительских игр в монолитные автономные файлы (NSP / NSZ / XCI):\n\n" +
                                      ...
                                      "2. Стандартизация v5.0.4 (Без раздувания и без ошибки 0x75B):\n" +
        ...
        private List<TopicItem> GetTopicsEn()
        {
            return new List<TopicItem>
            {
                ...
                new TopicItem
                {
                    ...
                    Category = "Algorithms",
                    Icon = "\uE945",
                    DescriptionText = "Intelligent automatic build method selection algorithm (Smart Processing) in v5.0.0:\n\n" +
        ...
        #region New Interactive Previews (v5.0.4)
        ...
        {
            var sp = new StackPanel { Spacing = 8 };
            sp.Children.Add(new TextBlock { Text = "🎮 Синхронизация с виртуальной картой эмулятора (SDMC v5.0.4):", FontWeight = Microsoft.UI.Text.FontWeights.Bold, FontSize = 14, Foreground = new SolidColorBrush(Microsoft.UI.Colors.LimeGreen) });
        ...
        private void BuildHomebrewInteractivePreview(StackPanel container)
        {
            ...
            { 
                Text = "🕹️ Интерактивный инспектор портов Homebrew (v5.0.4)", 
        ...
        private void BuildSmartProcessingInteractivePreview(StackPanel container)
        {
            ...
            mainSp.Children.Add(new TextBlock 
            { 
                Text = "🧠 Интерактивный калькулятор Умной обработки (Smart Processing v5.0.4)", 
                FontWeight = Microsoft.UI.Text.FontWeights.Bold, 
                FontSize = 15, 
                Foreground = new SolidColorBrush(Microsoft.UI.Colors.LimeGreen) 
            });
        ...
        private void BuildFormatConverterInteractivePreview(StackPanel container)
        {
            ...
            mainSp.Children.Add(new TextBlock 
            { 
                Text = "🔄 Интерактивный конфигуратор конвертации форматов (v5.0.4)", 
                FontWeight = Microsoft.UI.Text.FontWeights.Bold, 
                FontSize = 15, 
                Foreground = new SolidColorBrush(Microsoft.UI.Colors.DodgerBlue) 
            });
