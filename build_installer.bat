...
echo ==============================================
if exist "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_v3.9.2_Setup.exe" (
    ...
    del /f /q /a "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_v3.9.2_Setup.exe" 2>nul
)
