...
echo ==============================================
powershell -ExecutionPolicy Bypass -Command "Get-ChildItem 'e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish' -Recurse | Unblock-File -ErrorAction SilentlyContinue; & 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.28000.0\x64\signtool.exe' sign /fd SHA256 /d 'STORM SWITCH BOX 4.6.8' /du 'https://github.com/ReiKatari/STORM_SWITCH_BOX' /sha1 F8A8D6D6A6954867F08F480210CA0A81F2FEF756 'e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish\StormSwitchBox.exe'; & 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.28000.0\x64\signtool.exe' sign /fd SHA256 /d 'STORM SWITCH BOX 4.6.8' /du 'https://github.com/ReiKatari/STORM_SWITCH_BOX' /sha1 F8A8D6D6A6954867F08F480210CA0A81F2FEF756 'e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish\StormSwitchBox.dll'; Get-ChildItem 'e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish\tools' -Recurse -Filter *.exe | ForEach-Object { & 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.28000.0\x64\signtool.exe' sign /fd SHA256 /d 'STORM SWITCH BOX 4.6.8' /du 'https://github.com/ReiKatari/STORM_SWITCH_BOX' /sha1 F8A8D6D6A6954867F08F480210CA0A81F2FEF756 $_.FullName }"
...
if exist "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_win-x64.zip" ( del /f /q "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_win-x64.zip" )
if exist "e:\STORM SWITCH BOX\tools\7z.exe" (
    "e:\STORM SWITCH BOX\tools\7z.exe" a -tzip -mx=7 -mmt=on "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_win-x64.zip" "e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish\."
) else (
    powershell -Command "Compress-Archive -Path 'e:\STORM SWITCH BOX\bin\Release\net8.0-windows10.0.19041.0\win-x64\publish\*' -DestinationPath 'e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_win-x64.zip' -Force"
)
...
if exist "e:\STORM SWITCH BOX\installer\StormInstaller\bin\Release\net8.0-windows\win-x64\publish\StormInstaller.exe" (
    copy /y "e:\STORM SWITCH BOX\installer\StormInstaller\bin\Release\net8.0-windows\win-x64\publish\StormInstaller.exe" "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_Setup.exe" >nul
) else (
...
echo ==============================================
echo 5. Signing STORM_SWITCH_BOX_4.6.8_Setup.exe (Authenticode SHA-256)...
echo ==============================================
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.28000.0\x64\signtool.exe" sign /fd SHA256 /d "STORM SWITCH BOX 4.6.8" /du "https://github.com/ReiKatari/STORM_SWITCH_BOX" /sha1 F8A8D6D6A6954867F08F480210CA0A81F2FEF756 "e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_Setup.exe"
...
echo 1. Installer: e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_Setup.exe
echo 2. Portable:  e:\STORM SWITCH BOX\installer\Output\STORM_SWITCH_BOX_4.6.8_win-x64.zip
echo ==============================================
