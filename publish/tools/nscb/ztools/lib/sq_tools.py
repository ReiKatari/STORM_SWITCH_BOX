...
versions =
	...
	1342177280: "20.0.0"	  ->   keygeneration = 20
	1409286144: "21.0.0"	  ->   keygeneration = 21
'''
def kgstring():
	kg=list()
	# FW 19.0.0+ -> keygeneration 19+  (RSV = 19*67108864 = 1275068416, etc.)
	# FW 18.0.0  -> keygeneration 18   (RSV = 18*67108864 = 1207959552)
	# FW 17.0.0  -> keygeneration 17   (RSV = 17*67108864 = 1140850688)
	# FW 16.0.0  -> keygeneration 16   (RSV = 16*67108864 = 1073741824)
	# FW 15.0.0  -> keygeneration 15   (RSV = 15*67108864 = 1006632960)
	# FW 14.0.0  -> keygeneration 14   (RSV = 14*67108864 = 939524096)
	# The list is built in REVERSE order: highest kg first, lowest last
	kg21=[21*67108864];kg.append(kg21)
	kg20=[20*67108864];kg.append(kg20)
	kg19=[19*67108864];kg.append(kg19)
	kg18=[18*67108864, 18*67108864+1*1048576];kg.append(kg18)
	kg17=[17*67108864, 17*67108864+1*1048576];kg.append(kg17)
	kg16=[16*67108864, 16*67108864+1*1048576, 16*67108864+2*1048576];kg.append(kg16)
	kg15=[15*67108864, 15*67108864+1*1048576];kg.append(kg15)
	kg14=[939524096, 939524096+1048576];kg.append(kg14)
